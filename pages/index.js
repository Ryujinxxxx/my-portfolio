  ...
  const projects = [
    {
      ...
      description:
        "Developed a Python-based automation system to perform network diagnostics, configuration backups, and device monitoring. Streamlined repetitive workflows and ensured network reliability across multi-vendor devices.",
